...
A very nice companion to this analysis is the [DESeq2 tutorial](http://bioconductor.org/packages/devel/bioc/vignettes/DESeq2/inst/doc/DESeq2.html).
...
Okay, now we're on to real analysis. To make a PCA plot, we first apply the variance-stabilizing transformation (VST).
...
vsd <- vst(dds.filt, blind=FALSE, nsub=100)
```
